		...
		$('#invoiceDetailView').myDatagrid({
			...
			"method": "post", 
	  		"columns":[[
						...
						{field : 'coCode', title : '单据编号', 	 width : 60, align : 'center'},
						{field : 'orderDate', title : '税率', 	     width : 15, align : 'center'},
						{field : 'whCode', title : '含税单价', 	 width : 20, align : 'center'},
						{field : 'whName', title : '税额', 	     width : 20, align : 'center'},
						{field : 'orderCode', title : '价税合计', 	     width : 20, align : 'center'},
						{field : 'busType', title : '主计量数量', 	 width : 30, align : 'center'},
						{field : 'venName', title : '无税单价', 	 width : 25, align : 'center'},
						{field : 'cptName', title : '无税金额', 	     width : 25, align : 'center'},
						{field : 'auditStatus', title : '批号', 	     width : 30, align : 'center'},
						{field : 'statusDesc', title : '项目编码', 	 width : 20, align : 'center'}
	  				]],
			"toolbar": [{
	        	  id : 'data_form_detail',
	        	  text : '确定',
