 ...
 * 
 */
package com.multigold.mdm.web.component;
...
public class UserOperatorLogAspect {
	...
	@Pointcut("execution(* com.multigold.common.service.*.create*(..))")
	...
	@Pointcut("execution(* com.multigold.common.service.*.update*(..))")
	...
	@Pointcut("execution(* com.multigold.common.service.*.delete*(..))")
